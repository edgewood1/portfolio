...
class Apps extends Component {
  ...
  details = [{
        ...
        desc: "This app gathers new song recommendations from various music sites - It also allows a user to rate and save select songs to a playlist.",
    ...
    }, 
    {
        ...
        desc: "Using a user's topic input, this app will search articles in the pages of the New York Times -- It also allows a user to save and/or delete saved articles",
    ...
    },
    {
        ...
        desc: "This app allows the user to save itineraries of past and future trips.",
        ...
        desc: "This app allows you to submit a movie title, based on this title, it recommends a book - It also displays recent movies searched.",
        ...
        desc: "This app allows you to add projects and rate them as completed or not.",
