...
class Apps extends Component {
  ...
  details = [
      {
        object: "To be part of an Agile team working in a strong learning environment with a relevant tech stack.",
        front_skills: ["Bootstrap", "Materialize", "React", "JQuery"],
        back_skills: ["Node.JS", "Express", "SQL", "MongoDB", "Python/Django", "Perl", "Passport.JS"],
        personal: ["Being outdoors", "playing musical instruments", "exploring speculative fiction"]
      },
      [
    ...
    [
        {pgm: "Tutor/Teaching Assistant", 
            ...
            desc: ["We help students design and create apps using the MongoDB - Express - Node - React stack"],
          },
        ...
        {pgm: "Writing Instructor", 
            com: ["Durham Tech Community College, NC State, Center for Nature, Education, and the Imagination"],
            where: "Durham, Raleigh, Greensboro NC",
            when: "Aug 2002 - May 2017", 
            desc: ["Designed and taught courses in analytical, imaginative, and research techniques.", 
     ...
     [{
          ...
          desc: "Each week, we explore a new topic in the field of Python programming"
      }, {
          pgm: "Code for Durham", 
          where: "Durham, NC", 
          when: "Aug 2017- May 2018",
          desc: "This small group of volunteers explore how apps can help organize data and stories in a way that informs the community on the issues surrounding affordable housing.  (Django, PostgreSQL, D3)",
      }, {
          pgm: "PRESS study", 
          where: "Durham Tech Community College", 
          when: "Aug 2014 - Aug 2016", 
          desc: "In this two-year study, we analyzed course data and issues about equity and policy in order to implementstrategies that enable higher rates of student success. We presented findings to staff and faculty."
      }]
    ]
    ...
    render() {
        ...
        return(
            ...
            <hr></hr>
            <div>
                <p> <span style={bold}>OBJECTIVE:</span> {intro.object}</p>
                <hr></hr>
                <p style={this.large}> SKILLS: </p>  
                <p> <span style={bold}>Front-end:</span> {intro.front_skills.join(", ")}</p>
                <p> <span style={bold}>Back-end:</span> {intro.back_skills.join(", ")}</p>
                <p> <span style={bold}>Personal:</span> {intro.personal.join(", ")}</p>
                <hr></hr> 
                <p style={this.large}> EDUCATION: </p>  
                    {ed.map((e)=> 
                        <div>
                            <p style={this.medium}> {e.pgm},  {e.time},  {e.school}</p>
                            <p> {e.desc} </p> 
                        </div>
                    )}
                <hr></hr>
                <p style={this.large}> WORK: </p>
                    {work.map((e) => 
                        <div>
                            <p style={this.medium}>{e.pgm} -- {e.where}, {e.when}</p> 
                            {e.desc.map((f)=>
                            <div>
                                <li>{f}</li>
                                </div>
